...
(function () {
  ...
  var I18N = {
    ...
    en: {
      ...
      'about.github':             'GitHub',
      'about.email':              'Email',
      'about.digitalCraft':       'Burning quietly, growing inward',
      'about.digitalCraftDesc':   'Feeling the world through thought, making sense of myself through words. Quiet, but not cold. Sensitive, but not fragile.',
      'about.humanCentric':       'A soft glow, an occasional echo',
      'about.humanCentricDesc':   'Sharing what I feel like sharing, responding to what resonates. Hoping to offer you one more lens through which to see the world.',
